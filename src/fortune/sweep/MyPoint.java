...
class MyPoint implements Paintable
{
	...
	{
		/*
		 * int x = (int)this.x, y = (int)this.y; g.drawLine(x , y-2, x , y-2);
		 * g.drawLine(x-1, y-1, x+1, y-1); g.drawLine(x-2, y , x+2, y );
		 * g.drawLine(x-1, y+1, x+1, y+1); g.drawLine(x , y+2, x , y+2);
		 */
